...
Running many bots and services solo means status lives in terminals, plists, and chat memory. That’s fragile. I needed a single ops surface: what’s healthy, what’s degraded, what needs a human.
